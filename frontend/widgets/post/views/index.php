        ...
        <div class="panel-body border-bottom">      
            <div class="row">
                ...
                <div class="col-lg-8 btn-group">
                    ...
                    <a href="<?=Url::to(['post/view','id'=>$list['id']])?>"><button class="btn btn-info no-radius btn-sm pull-right">阅读全文</button></a>
                </div>
            </div>
            <div class="tags">
                <?php if(!empty($list['relate'])): ?>
                <span class="fa fa-tags"></span>
                    <?php foreach ($list['relate'] as $lt):?>
                        <span>
                            <a class="label" href="#"><?= $lt['tag']['tag_name']?></a>
                        </span>
                    <?php endforeach;?>
                <?php endif; ?>
            </div>
